...
sub goog {
   ...
   printf "|" . $redirectURI . "|";
   if ($unlucky) {
      public_msg($target_chan, "\cc12G\cc4o\cc7o\cc12g\cc9l\cc4e \cc0: \co " . $redirectURI  );
      public_msg($target_chan, "\cc12G\cc4o\cc7o\cc12g\cc9l\cc4e \cc0: \co " . $theURI  );
   }
   else {
      public_msg($target_chan, "\cc12G\cc4o\cc7o\cc12g\cc9l\cc4e \cc0: \co " . $redirectURI  );
   }
   ...
   if ( checkYT(trim($redirectURI)) ) {
       scrapeYT($redirectURI, $target_chan);
   }
